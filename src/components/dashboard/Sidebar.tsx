    ...
    <>
      ...
      <motion.aside
        ...
        <div className="absolute bottom-4 left-0 w-full px-3">
          ...
          <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 transition-colors mt-1">
