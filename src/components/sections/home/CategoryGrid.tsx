    ...
    <section className="w-full py-24 bg-white" id="categories">
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center flex flex-col gap-3 mb-16">
          <span className="font-bold text-[12px] tracking-[0.15em] uppercase text-secondary">Chọn sâm theo nhu cầu</span>
          <h2 className="text-3xl md:text-4xl font-serif text-primary">Giải Pháp Sức Khỏe Toàn Diện</h2>
        </div>
...
function CategoryCard({ icon, title, desc }: { icon: string; title: string; desc: string }) {
  return (
    <div className="flex flex-col gap-6 border border-outline-variant bg-surface p-10 hover:border-secondary transition-all hover:shadow-xl group rounded-2xl">
      ...
      <Link className="text-[12px] font-bold tracking-[0.15em] uppercase text-secondary flex flex-row items-center gap-2 group-hover:translate-x-2 transition-transform" href="#">
