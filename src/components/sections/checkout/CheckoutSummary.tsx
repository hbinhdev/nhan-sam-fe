    ...
    <div className="lg:col-span-5">
      <div className="sticky top-32 space-y-8 bg-surface-container-low p-8 border border-yellow-600/10 rounded-xl">
        <div className="flex items-center justify-between border-b border-outline-variant pb-4">
          ...
          <span className="text-label-caps text-primary">{totalItems} SẢN PHẨM</span>
        </div>
        ...
        <div className="space-y-6 max-h-[400px] overflow-y-auto pr-2 no-scrollbar">
          ...
          {items.length === 0 && (
            <p className="text-center py-8 text-on-surface-variant italic">Giỏ hàng đang trống</p>
          )}
        </div>
        ...
        <div className="space-y-3 pt-6 border-t border-outline-variant">
          ...
          <div className="flex justify-between items-center pt-4 border-t border-primary/20">
            ...
            <span className="text-headline-md text-primary font-bold">{formatCurrencyVND(total)}</span>
          </div>
        </div>
